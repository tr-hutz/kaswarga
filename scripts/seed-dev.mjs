...
const SAMPLE_AUTH_USERS = [
  ...
  { id: 'cccccccc-cccc-cccc-cccc-cccccccccc11', email: 'ketua@dev.com'      },
  { id: 'cccccccc-cccc-cccc-cccc-cccccccccc12', email: 'bendahara@dev.com' },
...
const PUBLIC_USERS = [
  ...
  { id: 'cccccccc-cccc-cccc-cccc-cccccccccc11', name: 'Hendra Wijaya',   email: 'ketua@dev.com',      created_at: '2026-01-03T08:00:00Z' },
  { id: 'cccccccc-cccc-cccc-cccc-cccccccccc12', name: 'Dewi Rahayu',     email: 'bendahara@dev.com',  created_at: '2026-01-03T08:00:00Z' },
...
const RESIDENTS = [
  // RT 01 — 10 residents
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb1', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Budi Santoso',       block: 'A', house_number: '01', email: 'admin@dev.com',      created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb2', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Siti Aminah',        block: 'A', house_number: '02', email: 'warga@dev.com',      created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb11', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Hendra Wijaya',      block: 'A', house_number: '03', email: 'ketua@dev.com',      created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb12', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Dewi Rahayu',        block: 'A', house_number: '04', email: 'bendahara@dev.com',  created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb13', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Agus Setiawan',      block: 'A', house_number: '05', email: 'agus@dev.com',    created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb14', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Fitri Handayani',    block: 'A', house_number: '06', email: 'fitri@dev.com',   created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb15', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Bambang Supriyanto', block: 'A', house_number: '07', email: 'bambang@dev.com', created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb16', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Sri Wahyuni',        block: 'A', house_number: '08', email: 'sri@dev.com',     created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb17', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Wahyu Pratama',      block: 'A', house_number: '09', email: 'wahyu@dev.com',   created_at: '2026-01-02T08:00:00Z' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb18', rt_id: '11111111-1111-1111-1111-111111111111', name: 'Eka Susanti',        block: 'A', house_number: '10', email: 'eka@dev.com',     created_at: '2026-01-02T08:00:00Z' },
  // RT 02 — 8 residents
