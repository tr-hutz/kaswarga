    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            <form
                ...
                className="bg-white rounded-xl p-6 w-full max-w-xl space-y-4 max-h-[90vh] overflow-y-auto"
            >
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="col-span-2">
                        <label className="text-xs text-dark-5 mb-1 block">{t('form.name')}</label>
                        <input
                            required
                    ...
                    <div>
                        <label className="text-xs text-dark-5 mb-1 block">{t('form.code')}</label>
                        <input
                    ...
                    <div>
                        <label className="text-xs text-dark-5 mb-1 block">{t('form.postalCode')}</label>
                        <input
                    ...
                    <div className="col-span-2">
                        <label className="text-xs text-dark-5 mb-1 block">{t('form.address')}</label>
                        <input
                    ...
                    <div>
                        <label className="text-xs text-dark-5 mb-1 block">{t('form.city')}</label>
                        <input
                    ...
                    <div>
                        <label className="text-xs text-dark-5 mb-1 block">{t('form.province')}</label>
                        <input
