 ...
 *   3. Seed data — roles (6), permissions (46), role_permissions (93)
...
BEGIN
    ...
    -- 93 role-permission assignments
    --   RT_ADMIN=37, RT_CHAIR=21, TREASURER=20, SECRETARY=10, RESIDENT=5
    SELECT COUNT(*) INTO v_count FROM role_permissions;
    ASSERT v_count = 93,
        format('Expected 93 role_permissions rows, found %s', v_count);
